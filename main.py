...
def load_player_data(cpm):
    ...
    if response.get('ok'):
        ...
        if 'floats' in data and 'localID' in data and 'money' in data and 'coin' in data:
            ...
            print(Colorate.Horizontal(Colors.rainbow, '==========[ GIDEON DETAILS ]=========='))
...
def load_key_data(cpm):
    ...
    print(Colorate.Horizontal(Colors.rainbow, '========[ MANOK KEY DETAILS ]========'))
...
def load_client_details():
    ...
    data = response.json()
    print(Colorate.Horizontal(Colors.rainbow, '=============[ MANOK ]============='))
